      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php foreach($tb_nilaisiswa as $ns) : ?>
           <form method="post" action="<?php echo base_url('administrator/guru/nilaisiswa/update_aksi') ?>">
            <div class="card-body">
                <div class="form-group">
                <label>NIS</label>
                <input type="hidden" name="id_nilai" class="form-control" value="<?php echo $ns->id_nilai?>">
                <input type="text" name="nis" class="form-control" value="<?php echo $ns->nis ?>" placeholder="<?php foreach ($tb_siswa as $sw) : ?>
                    <?php echo $sw->nis; ?>
...
<!--                 <?php
              ...
              <div class="form-group">
                ...
                <input type="text" name="kelas" class="form-control" value="<?php echo $ns->kelas ?>" placeholder="<?php foreach ($tb_kelas as $kl) : ?>
                    <?php echo $kl->kelas; ?>
                <?php endforeach; ?>" readonly>
               ...
               <div class="form-group">
                ...
                <select class="form-control custom-select" name="semester" value="<?php echo $ns->semester ?>" >
                  <option selected><?php echo $ns->semester ?></option>
              ...
              <label for="inputName">Tahun Ajaran</label>
                <input type="text" name="thn_ajaran" class="form-control" data-inputmask='"mask": "2099/2099"' data-mask value="<?php echo $ns->thn_ajaran ?>">
