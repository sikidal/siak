      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
           <form method="post" action="<?php echo base_url('administrator/admin/nilaisiswa/input_aksi') ?>">
            <div class="card-body">
...
<!--                 <?php
             ...
             <div class="form-group">
                ...
                <select name="kelas" class="form-control custom-select" data-placeholder="-Pilih-" style="width: 100%;">
                  <option selected disabled>-Pilih-</option>
                  <?php foreach ($tb_kelas as $mp) : ?>
                    <option value="<?php echo $mp->kelas?>"><?php echo $mp->kelas; ?></option>
                  <?php endforeach; ?>
                  </select>
               ...
               <div class="form-group">
                ...
                <select name="semester" class="form-control custom-select" data-placeholder="-Pilih-" style="width: 100%;">
                  <option selected disabled>-Pilih-</option>
