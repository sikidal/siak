...
<section class="content">
      ...
      <div class="row">  
        ...
        <div class="col-md-12">
           ...
           <?php echo form_open_multipart('administrator/admin/dataguru/input_aksi'); ?>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="nip" data-inputmask='"mask": "9999 9999 999 99 9"' data-mask>
                  </div>
