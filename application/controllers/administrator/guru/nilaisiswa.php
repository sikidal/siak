...
class Nilaisiswa extends CI_Controller{
	...
	{		
		...
		$this->load->view('administrator/guru/nilaisiswa',$data);
	...
	public function input()
		...
		$this->load->view('templates_administrator/header');
		$this->load->view('templates_administrator/sidebarguru');
		$this->load->view('administrator/guru/nilaisiswa_tambah',$data);
		$this->load->view('templates_administrator/footer');
		}
	...
	public function input_aksi()
		...
		if($this->form_validation->run() == FALSE){
			...
			redirect('administrator/guru/nilaisiswa');
			}
	...
	// 	$this->load->view('templates_administrator/header');
	// 	$this->load->view('templates_administrator/sidebarguru');
	// 	$this->load->view('administrator/guru/nilaisiswa_update',$data);
	// 	$this->load->view('templates_administrator/footer');
	// }
